...
public class StringRequest extends Request<String> {
     ...
     */
    public StringRequest(int method, String url, Map<String, String> urlParams, 
     ...
     * @param errorListener Error listener, or null to ignore errors
     */
    public StringRequest(String url, Map<String, String> urlParams, 
    		Listener<String> listener, ErrorListener errorListener) {
        this(Method.GET, url, urlParams, listener, errorListener);
    }
