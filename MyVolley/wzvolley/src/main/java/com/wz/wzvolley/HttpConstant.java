...
public class HttpConstant {
	 ...
	 public static final String ASCII = "ASCII";
	  ...
	  public final static String LINEND = "\r\n";

	  public final static String BOUNDARY = java.util.UUID.randomUUID().toString();

	  public final static String PREFIX = "--";

	  public final static String MUTIPART_FORMDATA = "multipart/form-data";
